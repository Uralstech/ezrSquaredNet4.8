...
namespace ezrSquared.Libraries.IO
{
    public class console : baseFunction
    {
        ...
        private runtimeResult setCursorVisibility(context context, position[] positions)
        {
            ...
            Console.CursorVisible = (bool)((value)visibility).storedValue;
        ...
        private runtimeResult setCursorPosition(context context, position[] positions)
        {
            ...
            item[] posArray = (pos is array) ? ((item[])((array)pos).storedValue) : ((List<item>)((list)pos).storedValue).ToArray();
        ...
        private runtimeResult keyPressed(context context, position[] positions)
        {
            ...
            bool shiftPress = ((bool)((value)shift).storedValue) ? (keyPress.Modifiers & ConsoleModifiers.Shift) != 0 : true;
            bool controlPress = ((bool)((value)control).storedValue) ? (keyPress.Modifiers & ConsoleModifiers.Control) != 0 : true;
            bool altPress = ((bool)((value)alt).storedValue) ? (keyPress.Modifiers & ConsoleModifiers.Alt) != 0 : true;
